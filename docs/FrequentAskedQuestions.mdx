...
## Both burnable/mintable extensions do not involve the state of adding storage. What should I do if my extension involves adding the state that needs to be stored?
...
pub struct State {
    ...
    pub allowances: RefCell<TokenAllowances>,
		...
		pub example_datas: RefCell<HashMap<String,Nat>>,
}
```